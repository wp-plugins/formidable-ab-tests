...
== Description == 
This plugin provides a shortcode to indicate which Formidable Pro forms to choose from, then randomly dislpays one of the forms each time the page is shown. 
Also ads and admin page to view results and determine which version is "winning" the A/B test.
